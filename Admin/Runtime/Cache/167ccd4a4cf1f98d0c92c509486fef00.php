...
<div class="dialog_content">
	<form id="info_form" name="info_form" action="<?php echo u('user_bank/add');?>" method="post">
...
<script>
var check_name_url = "<?php echo U('member_setting/ajax_check_name');?>";
var check_num_url = "<?php echo U('member_setting/ajax_check_num');?>";
var check_num_url2 = "<?php echo U('member_setting/ajax_check_num1');?>";
$(function(){
