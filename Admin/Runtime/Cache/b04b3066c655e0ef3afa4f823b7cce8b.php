...
<body scroll="no">
<div id="header">
	<div class="logo"><a href="__APP__" title="<?php echo L('website_manage');?>"><img src="/static/images/admin/logo.png"  alt=""  style="width: 38%;"/></a></div>
    <div class="fr">
    	<div class="cut_line admin_info tr">
        	<!--<a href="./" target="_blank"><?php echo L('site_home');?></a>
        	<span class="cut">|</span>-->
        	当前商城: <span class="mr10">[ <?php echo ($my_admin['wxname']); ?> ]</span>
    ...
    <div class="right_main">
    	<div class="crumbs">
    		...
    		<div id="J_mtab" class="mtab">
                ...
                <div class="mtab_p">
                    <div class="mtab_b">
                        <ul id="J_mtab_h" class="mtab_h"><li class="current" data-id="0"><span><a>信息面板</a></span></li></ul>
                    </div>
                </div>
            </div>
        </div>
