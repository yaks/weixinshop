               ...
               <td align="center"><b style="color:red">¥<?php echo ($val["order_sumPrice"]); ?></b></td>
                ...
                <td align="center" >
                   <?php switch($val["supportmetho"]): case "1": ?>支付宝支付<?php break;?>
                         ...
                         <?php case "4": ?>银行转账<?php break; endswitch;?>
                 <br>
                ...
                <td align="center"><a href="<?php echo u('item_order/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>">查看</a>| <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('item_order/delete', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['orderId']);?>"><?php echo L('delete');?></a>| <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('item_order/cancle', array('id'=>$val['orderId']));?>" data-acttype="ajax" data-msg="<?php echo '是否取消:'.$val['orderId'].' 的订单吗?';?>">取消</a>  </td>
